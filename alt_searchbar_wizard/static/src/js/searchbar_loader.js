...
;(function () {
    ...
    function createSearchbarHTML(data) {
        ...
        var html = '<div class="container-lg">'
        html += '<form class="row g-3" method="GET" action="/shop">';
        ...
        if (data.attributes && data.attributes.length > 0) {
            ...
            data.attributes.forEach(function (attr) {
                ...
                html += '<option value="">כל האפשרויות</option>'
        ...
        if (data.show_price_filter && data.price_ranges) {
            ...
            html += '<option value="">כל המחירים</option>'
        ...
        html +=
            '<button type="submit" class="btn btn-primary me-2">חיפוש</button>'
        html +=
            '<button id="reset_button" type="button" class="btn btn-primary me-2">אִתחוּל</button>'
        html +=
            '<button id="close_button" type="button" class="btn btn-danger text-end me-2" title="Close">×</button>'
        html += "</div>"
        html += "</form>"
        html += "</div>"
