...
=======================
* This module enables company-restricted direct communication in vendor pricelists and purchase workflows.

Configuration
=============
* To enable direct communication, mark the company as 'Main Company' using the 'Is Main' boolean in the Company settings.

* Only users from a Main Company can edit the 'Direct Communication' field in vendor pricelists.
Company
-------
