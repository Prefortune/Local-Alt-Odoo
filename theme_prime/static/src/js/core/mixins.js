...
export const CartManagerMixin = Object.assign({}, B2bMixin, {
    ...
    _cartNotification: function (data) {
        this.displayNotification({
            ...
            templateToUse: 'theme_prime.NotificationGeneric',
            message: markup(renderToString('DroggolNotification', { color: 'primary', productID: data.product_id, productName: data.product_name, message: _t('המוצר נוסף לעגלה שלך.')})),
    ...
    _outOfStockNotification: function (data) {
        this.displayNotification({
            ...
            templateToUse: 'theme_prime.NotificationGeneric',
            message: markup(renderToString('DroggolNotification', { subIconClass: 'fa fa-exclamation-circle', color: 'danger', productID: data.product_id, productName: _t('Currently not in stock.'), message: _t('יש לבדוק מאוחר יותר.')})),
