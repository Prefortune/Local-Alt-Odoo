...
class ProductTemplate(models.Model):
    ...
    product_description_content = fields.Html(string="Product Description Content", help="Content for the Product Description tab on the product page.")
    read_more_content = fields.Html(string="Read More Content", help="Content for the Read More tab on the product page.")
    shipping_policy_content = fields.Html(string="Shipping Policy Content")
    the_labels_content = fields.Html(string="The Labels Content")
    recommend_use_content = fields.Html(string="Recommend Use Content")
    statement_content = fields.Html(string="Statement Content")
    components_content = fields.Html(string="Components Content")
