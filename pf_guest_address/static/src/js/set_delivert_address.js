...
publicWidget.registry.websiteSaleAddress.include({
    ...
    start() {
        ...
        console.log("flag_is_enable_company_vat_visible -",flag_is_enable_company_vat_visible , typeof flag_is_enable_company_vat_visible);
        
        if (flag_is_enable_company_vat_visible === 'True'){
            this.requiredFields.push('personal_name','personal_email','personal_phone', 'street' , 'city' ) 
        }
        else{
            this.requiredFields.push('personal_name','personal_email','personal_phone','personal_company' , 'personal_vat' , 'street' , 'city') 

        }
        console.log("start from odoo custom addons",this.requiredFields)
