...
class ProductTemplate(models.Model):
    ...
    def get_available(self,is_dynamic=True):
        ...
        config_setting = self.env['website.stock.config.settings'].sudo().search([('website_id', '=', current_website.id),('is_active', '=', True)], limit=1)
...
class Website(models.Model):
    ...
    def sale_product_domain(self):
        ...
        config_setting = self.env['website.stock.config.settings'].sudo().search([('website_id', '=', self.id),('is_active', '=', True)], limit=1)
