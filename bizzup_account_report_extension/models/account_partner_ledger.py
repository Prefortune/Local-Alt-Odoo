...
class PartnerLedgerCustomHandler(models.AbstractModel):
    ...
    def _get_aml_values(self, options, partner_ids, offset=0, limit=None):
        ...
        for column_group_key, group_options in report._split_options_per_column_group(options).items():
            ...
            # Directly linked move lines
            queries.append(SQL(
                '''
                SELECT
                    account_move_line.id,
                    COALESCE(account_move_line.date_maturity, account_move_line.date) AS date_maturity,
                    account_move_line.create_date AS create_date,
                    payment.validity_date AS validity_date,
            ...
            # Indirectly linked move lines (through reconciliation)
            queries.append(SQL(
                '''
                SELECT
                    account_move_line.id,
                ...
                WHERE
                    ...
                    AND payment.id = account_move_line.payment_id
