...
class NonMovingProductWizard(models.TransientModel):
    ...
    def sh_print_stock_report(self):
        ...
        datas = self.read()[0]
        res = self.env.ref(
            'sh_non_moving_product_report.sh_non_moving_product_report_action').report_action([], data=datas)
        return res
    ...
    def sh_non_moving_view(self):
        ...
        if self:
            ...
            return {
                ...
                'view_mode': 'list',
                'view_id': self.env.ref('sh_non_moving_product_report.sh_non_moving_product_view_tree').id,
                }