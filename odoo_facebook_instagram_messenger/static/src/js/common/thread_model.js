...
patch(Thread.prototype, {
    _computeDiscussAppCategory() {
        return this.channel_type === "FbChannels" && this.length > 0 ? this.store.discuss.FbChannels : super._computeDiscussAppCategory();
        return this.channel_type === "InstaChannels" && this.length > 0 ? this.store.discuss.InstaChannels : super._computeDiscussAppCategory();
    },
     get canUnpin() {
