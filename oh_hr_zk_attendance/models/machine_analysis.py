...
class ZkMachine(models.Model):
    ...
    device_id = fields.Char(string='Biometric device id 83.111.122.42',
                            help="Biometric device id 83.111.122.42")
    device_id_2 = fields.Char(string="Biometric Device ID For Machine  IP 83.111.120.41")
...
class ReportZkDevice(models.Model):
    ...
    device_id = fields.Char(string='Biometric Device ID',
                            help="Biometric device id 83.111.120.41")
    device_id_2 = fields.Char(string="Biometric Device ID For Machine  IP 83.111.122.42")
